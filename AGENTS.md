...
`ProfileId` in Rust / TS is for **in-app** gating and UX (`unknown`, `infinitime`, …). **Firmware support** is documented in the catalog’s **firmware matrix**, not by overloading profile names.
